...
const sidebarItems = [
  ...
  { label: "Leaves", icon: LifeBuoy, href: "/leaves" },
  { label: "Reports", icon: ShieldCheck, href: "/reports" },
...
function TableHead({ children }: { children: React.ReactNode }) {
  return (
    <th className="whitespace-nowrap px-4 py-3 text-left text-xs font-semibold uppercase text-slate-400">
      {children}
    </th>
  );
}
